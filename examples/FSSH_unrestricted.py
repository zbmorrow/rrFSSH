...
chkDir = 'FSSH_unrestricted_example'
...
dataE = ev2ieu * np.loadtxt('%s/energy_S0_unrestricted.dat' % state_folder)
...
energy_S1 = ev2ieu * np.loadtxt('%s/energy_S1.dat' % state_folder)
energy_S1 = np.reshape(energy_S1,(N_trig,N_poly))
sg_trig_energy_ES.loadNeededPoints(energy_S1)
...
burn_in_dir = 'langevin_unrestricted'
...
NACfull = np.loadtxt('%s/NACfull_unrestricted.dat' % state_folder)
