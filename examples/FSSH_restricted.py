...
chkDir = 'FSSH_restricted_example'
...
dataE = ev2ieu * np.loadtxt('%s/energy_S0_restricted.dat' % state_folder)
...
burn_in_dir = 'langevin_restricted'
...
NACfull = np.loadtxt('%s/NACfull_restricted.dat' % state_folder)
